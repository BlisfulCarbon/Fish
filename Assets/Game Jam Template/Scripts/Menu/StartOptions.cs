...
public class StartOptions : MonoBehaviour {
	...
	public static Action _gameStart;
	...
	public void StartButtonClicked()
	{
		...
		if (menuSettingsData.nextSceneIndex != 0) 
		{
            ...
            StartCoroutine(FadeCanvasGroupAlpha(0f, 1f, fadeOutImageCanvasGroup, null));
	...
	public void StartGameInScene()
	{
        ...
        StartCoroutine(FadeCanvasGroupAlpha(1f,0f, menuCanvasGroup, ()=> {_gameStart?.Invoke();}));
	}

	public static void SubscribeGameStart(Action callBack) => 
		_gameStart += callBack;
